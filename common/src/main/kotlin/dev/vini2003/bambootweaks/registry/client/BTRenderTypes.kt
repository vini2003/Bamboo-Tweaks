...
object BTRenderTypes {
	fun init() {
		...
		RenderTypeRegistry.register(RenderLayer.getCutout(), BTBlocks.BambooTrapdoor.get())
		...
		RenderTypeRegistry.register(RenderLayer.getCutout(), BTBlocks.DryBambooTrapdoor.get())
