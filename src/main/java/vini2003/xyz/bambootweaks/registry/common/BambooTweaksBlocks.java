...
public class BambooTweaksBlocks {
	...
	public static final Block DRIED_BAMBOO_BLOCK = register("dried_bamboo_block", new Block(FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).strength(0.5F, 2.5F)), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_DOOR = register("dried_bamboo_door", new ExposedDoorBlock(FabricBlockSettings.of(Material.BAMBOO).strength(3.0F, 0.0F).sounds(BlockSoundGroup.BAMBOO).nonOpaque()), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_FENCE_BLOCK = register("dried_bamboo_fence", new FenceBlock(FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).strength(2.0F, 3.0F)), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_FENCE_GATE_BLOCK = register("dried_bamboo_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).strength(2.0F, 3.0F)), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_FENCE_WALL_BLOCK = register("dried_bamboo_wall", new BlockBambooWall(FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).strength(2.0F, 3.0F)), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_LADDER_BLOCK = register("dried_bamboo_ladder", new ExposedLadderBlock(FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).strength(0.4F, 0.0F).nonOpaque()), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_ROD = register("dried_bamboo_rod", new BlockBambooRod(FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).breakInstantly()), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_SPIKE_BLOCK = register("dried_bamboo_spike", new BlockBambooSpike(FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).strength(2.0F, 3.0F)), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_STAIRS_BLOCK = register("dried_bamboo_stairs", new ExposedStairsBlock(BAMBOO_BLOCK.getDefaultState(), FabricBlockSettings.of(Material.BAMBOO).sounds(BlockSoundGroup.BAMBOO).strength(2.0F, 3.0F)), new Item.Settings().group(BambooTweaksItemGroups.BAMBOO_TWEAKS));
	public static final Block DRIED_BAMBOO_TORCH_BLOCK = register("dried_bamboo_torch", new ExposedTorchBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT).luminance(14).noCollision().sounds(BlockSoundGroup.BAMBOO).nonOpaque(), ParticleTypes.FLAME), (BlockItem) null);
	public static final Block DRIED_BAMBOO_TORCH_BLOCK_WALL = register("dried_bamboo_torch_wall", new ExposedWallTorchBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT).luminance(14).noCollision().sounds(BlockSoundGroup.BAMBOO).nonOpaque(), ParticleTypes.FLAME), (BlockItem) null);
