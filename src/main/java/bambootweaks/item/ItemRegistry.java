...
public class ItemRegistry {
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier("bambootweaks", "bamboo_torch"), new WallStandingBlockItem(BlockRegistry.BAMBOO_TORCH_BLOCK, BlockRegistry.BAMBOO_TORCH_BLOCK_WALL, new Item.Settings().group(ItemGroup.DECORATIONS)));
    }
}