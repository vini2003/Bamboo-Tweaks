...
public class BlockRegistry {
    ...
    public static final Block BAMBOO_TORCH_BLOCK = new BlockBambooTorch(FabricBlockSettings.of(Material.PART).lightLevel(14).noCollision().sounds(BlockSoundGroup.WOOD).build());
    public static final Block BAMBOO_TORCH_BLOCK_WALL = new BlockBambooTorchWall(FabricBlockSettings.of(Material.PART).lightLevel(14).noCollision().sounds(BlockSoundGroup.WOOD).build());
